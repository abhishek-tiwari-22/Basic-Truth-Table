...
#define W ((c|~d)&b)&~(d|a)           // change the expression here to find its truth table(no spaces)
#define N 4                          // change number of variables here
...
void Equation::four() {
    cout<<"Truth Table for given equation"<<endl;
    cout << "---------------------------------" << endl;
